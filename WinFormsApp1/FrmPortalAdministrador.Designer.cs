namespace Systema.De_Gestion.Academica.UI
{
    partial class FrmPortalAdministrador
    {
        ...
        private void InitializeComponent()
        {
            ...
            groupEstudiantes.SuspendLayout();
            groupDocentes.SuspendLayout();
            groupMaterias.SuspendLayout();
            groupCalificaciones.SuspendLayout();
            groupAsistencia.SuspendLayout();
            groupReportes.SuspendLayout();
            groupHorarios.SuspendLayout();
            SuspendLayout();
            // 
            // panelMenu
            // 
            ...
            // labelSistema
            // 
            labelSistema.Font = new Font("Comic Sans MS", 12F, FontStyle.Bold);
            ...
            labelTitulo.Font = new Font("Comic Sans MS", 18F, FontStyle.Bold);
            labelTitulo.Location = new Point(25, 20);
            labelTitulo.Name = "labelTitulo";
            labelTitulo.Size = new Size(259, 35);
            ...
            labelBienvenida.Font = new Font("Comic Sans MS", 10F);
            labelBienvenida.Location = new Point(28, 60);
            labelBienvenida.Name = "labelBienvenida";
            labelBienvenida.Size = new Size(179, 19);
            ...
            groupEstudiantes.Font = new Font("Comic Sans MS", 9F, FontStyle.Bold);
            groupEstudiantes.Location = new Point(25, 100);
            groupEstudiantes.Name = "groupEstudiantes";
            groupEstudiantes.Size = new Size(145, 100);
            groupEstudiantes.TabIndex = 2;
            groupEstudiantes.TabStop = false;
            ...
            labelMaterias.Size = new Size(104, 15);
            labelMaterias.TabIndex = 0;
            labelMaterias.Text = "Gestionar materias";
            // 
            // groupCalificaciones
            // 
            groupCalificaciones.Controls.Add(labelCalificaciones);
            groupCalificaciones.Font = new Font("Comic Sans MS", 8.5F, FontStyle.Bold);
            ...
            groupCalificaciones.TabIndex = 5;
            groupCalificaciones.TabStop = false;
            ...
            labelHorarios.Size = new Size(107, 15);
            ...
            groupEstudiantes.ResumeLayout(false);
            groupEstudiantes.PerformLayout();
            groupDocentes.ResumeLayout(false);
            groupDocentes.PerformLayout();
            groupMaterias.ResumeLayout(false);
            groupMaterias.PerformLayout();
            groupCalificaciones.ResumeLayout(false);
            groupCalificaciones.PerformLayout();
            groupAsistencia.ResumeLayout(false);
            groupAsistencia.PerformLayout();
            groupReportes.ResumeLayout(false);
            groupReportes.PerformLayout();
            groupHorarios.ResumeLayout(false);
            groupHorarios.PerformLayout();
            ResumeLayout(false);
        }
